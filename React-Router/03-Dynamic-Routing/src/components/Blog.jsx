...
const Blog = () => {
  ...
  //using useLocation(return a object with different values) at blog page and state property of useLocation at Blogs page for transfering data toward bloc is used instead of useParams-->> it reduces the finding data using conditiion inside the useEfeect 
  const location = useLocation();
  const {id, title, description} = location.state.blog;
